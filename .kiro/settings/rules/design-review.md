...
- **Frontend**: Verify alignment with UI/component patterns
- **Backend**: Verify alignment with API and service patterns
- **Database**: Verify alignment with schema and query patterns
- **Testing**: Verify alignment with test strategy and coverage
