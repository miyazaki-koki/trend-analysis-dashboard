...
|--------|---------------|---------------|
| **Frontend** | `frontend.md` | UI components, state management, styling |
| **Backend** | `backend.md` | Service architecture, data access patterns |
| **Database** | `database.md` | Schema design, migrations, queries |
| **Testing** | `testing.md` | Test strategy, coverage, patterns |
| **Deployment** | `deployment.md` | Release process, infrastructure patterns |
